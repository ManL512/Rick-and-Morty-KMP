...
/**
 * Overload allowing a fully custom title composable.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun CustomScreen(
...
// --- Convenience preview usage snippet (platform previews may vary in MPP) ---
/*
@Composable
fun ExampleScreen() {
    CustomScreen(
        ...
        actions = {
            // IconButton(onClick = { /* TODO */ }) { Icon(Icons.Default.MoreVert, null) }
        },
        bottomBar = { /* NavigationBar() */ },
        floatingActionButton = { /* FloatingActionButton { Icon(Icons.Default.Add, null) } */ }
    ) {
        // Screen content here
        Text("Hello from CustomScreen", modifier = Modifier.padding(16.dp))
    }
}
*/
